    ...
    dv.source(data)
      ...
      .transform({
        ...
        callback(row) {
          ...
          newRow[titleMap.y9] = row.y9;
          return newRow;
        },
      })
      .transform({
        type: 'fold',
        fields: [titleMap.y1, titleMap.y2, titleMap.y3, titleMap.y4, titleMap.y5, titleMap.y6, titleMap.y7, titleMap.y8, titleMap.y9], // 展开字段集
        key: 'key', // key字段
        value: 'value', // value字段
      });
